...
<div class="stats flex flex-col justify-center items-center w-max h-max ml-auto mr-auto relative">
  <h1>BEM VINDO MAURILIO</h1>
  <h2>Navegue pelo painel de administração</h2>
    <!-- <div class="stat">
