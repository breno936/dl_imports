<script lang="ts">
  ...
  import type { Destaques, Product, Sizes } from '@prisma/client';
   ...
   <div class="flex items-center">
        ...
        <form class="flex ml-auto w-full justify-center flex-wrap gap-4" on:submit={editDestaques}>
          ...
          <input
            ...
            class="input input-bordered w-[48%] max-w-xs mt-4"
          />
          <select bind:value={destaque.categoryId} class="select select-bordered w-full mt-4">
