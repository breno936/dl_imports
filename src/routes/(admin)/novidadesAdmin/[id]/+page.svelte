<script lang="ts">
  ...
  import type { Novidades, Product, Sizes } from '@prisma/client';
  ...
  async function editNovidade(event: any) {
    ...
    if (res.ok) {
      ...
      const divsToRemove = imgContainer.querySelectorAll(':scope > div');
        console.log(imgContainer, divsToRemove);
...
<div>
    ...
    <div class="text-center ml-auto mr-auto pt-8 w-3/5">
        ...
        <div class="flex items-center">
          ...
          <label for="newInputile" class="cursor-pointer relative ml-4 hover:scale-110"><svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z"/></svg></label>
        ...
        <form class="flex ml-auto w-full justify-center flex-wrap gap-4" on:submit={editNovidade}>
          ...
          <input
            ...
            class="input input-bordered w-[48%] max-w-xs mt-4"
          />
          <select bind:value={novidade.categoryId} class="select select-bordered w-full mt-4">
