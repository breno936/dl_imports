              ...
              <div class="pt-6" id="filter-section-mobile-1">
                <div class="space-y-6">
                  <div class="flex items-center">
                    ...
                    <label for="filter-mobile-category-0" class="ml-3 min-w-0 flex-1 text-gray-500">Moletons</label>
                  </div>
                  <div class="flex items-center">
          ...
          <form class="hidden lg:block">
            ...
            <div class="border-b border-gray-200 py-6">
              <h3 class="-my-3 flow-root">
                <!-- Expand/collapse section button -->
                <button on:click={() => {hiddenFilter1 = !hiddenFilter1;}} type="button" class="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-0" aria-expanded="false">
                  <span class="font-medium text-gray-900">Color</span>
                  <span class="ml-6 flex items-center">
                    <!-- Expand icon, show/hide based on section open state. -->
                    <svg class:hidden={!hiddenFilter1} class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                      <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                    </svg>
                    <!-- Collapse icon, show/hide based on section open state. -->
                    <svg class:hidden={hiddenFilter1} class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <!-- Filter section, show/hide based on section state. -->
              <div class="pt-6" class:hidden={hiddenFilter1} id="filter-section-0">
                <div class="space-y-4">
                  <div class="flex items-center">
