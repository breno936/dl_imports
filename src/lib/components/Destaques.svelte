<script lang="ts">
  ...
  import type { Destaques } from '@prisma/client';
  import { cartProducts } from "../../store";

    let destaqueList: Destaques[] = [];
    let token: string;
    ...
    destaqueList = data.destaques;
    console.log(destaqueList);
    ...
    $cartProducts = JSON.parse(listaLocalStorage);
      ...
      var swiper = new Swiper(".mySwiperDestaques", {
      slidesPerView: 3,
      spaceBetween: 30,
      loop:true,
      grabCursor: true,
...
<div class="w-4/6 h-[620px] ml-auto mr-auto mt-24 mb-24">
    <h1 class="text-[40px]">DESTAQUES</h1>
        <div class="swiper mySwiperDestaques">
            ...
            <div class="swiper-button-prev swiper-button-prevDestaques"></div>
            <div class="swiper-button-next swiper-button-nextDestaques"></div>
