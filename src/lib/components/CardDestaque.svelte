  ...
  onMount(() => {
    ...
    window.addEventListener("resize", function(){
      ...
      if(st > 1200){
        ...
        card1.style.animationName = "cardShow";
        card2.style.animationName = "cardShow";
      }
    });
...
<div class="bg-black w-full box-border pb-10 px-44 top-[-300px] relative">
    <svg
       version="1.0"
       width="953.000000pt"
       height="960.000000pt"
      ...
      <path
        ...
        <div id="card1" class="w-2/5 h-[500px] mb-10 bg-green-50 relative cursor-pointer card">
    ...
    <div id="card2" class="w-2/5 ml-auto mt-24 h-[500px] mb-10 bg-green-50 cursor-pointer relative card">
